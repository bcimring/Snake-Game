...
greenbody = pygame.image.load("snakebody_flashgreen.png")
greenbody = greenbody.convert_alpha()
greenbody = pygame.transform.scale(greenbody,(40,40))

redbody = pygame.image.load("snakebody_flashred.png")
...
pygame.mixer.init()
pygame.mixer.music.load('Mariachi.mp3')
...
while keepPlaying:                                                  #
    ...
    compensateTime = 0                                              # compensate time variable for delays
                                                                    #
    head = pygame.image.load("snakehead.png")                       # load snakehead looking to the right
